...
setwd("C:/Users/amanda.kihlman/R-test/AR6_Implementering/Input/ITR-reg-scenariodata_csv_sector_2")
...
benchdown <- c("Emissions|Kyoto Gases","Emissions|CO2|Energy and Industrial Processes","INT.emKyoto_gdp","INT.emCO2Elec_elecGen","INT.emCO2EI_PE","INT.emCO2EI_elecGen","INT.emCO2Transport_gdp","Emissions|CO2|AFOLU","Emissions|CO2|Energy","Emissions|CO2|Energy|Demand","Emissions|CO2|Energy|Demand|Industry","Emissions|CO2|Energy|Demand|Industry|Chemicals","Emissions|CO2|Energy|Demand|Industry|Pulp and Paper","Emissions|CO2|Energy|Demand|Industry|Steel","Emissions|CO2|Energy|Demand|Residential and Commercial","Emissions|CO2|Energy|Demand|Transportation","Emissions|CO2|Energy|Demand|Transportation|Aviation","Emissions|CO2|Energy|Demand|Transportation|Maritime","Emissions|CO2|Energy|Demand|Transportation|Rail","Emissions|CO2|Energy|Demand|Transportation|Road","Emissions|CO2|Energy|Supply","Emissions|CO2|Energy|Supply|Electricity","Emissions|CO2|Industrial Processes",
